...
import com.example.student.databinding.ActivityParentComplaintBinding;
...
public class ParentComplaintActivity extends AppCompatActivity {
    ActivityParentComplaintBinding binding;
    FirebaseAuth auth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding=ActivityParentComplaintBinding.inflate(getLayoutInflater());
