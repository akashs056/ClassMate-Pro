...
import com.example.student.databinding.SampleCourseBinding;
...
public class CoursePdfAdapter extends RecyclerView.Adapter<CoursePdfAdapter.viewHolder>{
    ...
    public CoursePdfAdapter(ArrayList<FileModel> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull viewHolder holder, int position) {
        ...
        holder.binding.subject.setText(model.getTitle());
    }
    ...
    public static class viewHolder extends RecyclerView.ViewHolder{
        SampleCourseBinding binding;

        public viewHolder(@NonNull View itemView) {
            super(itemView);
            binding=SampleCourseBinding.bind(itemView);
